...
* 연락처: 010-4301-2550
* 주소: 서울시 송파구 송파동 
* 이메일: kwonsimone@gmail.com
* 학력: 08~12 메이지대학(일본, 도쿄) - 상학부(Commerce)
...
* 익명의 실시간 투표를 통해 간편하게 여론조사를 할 수 있습니다.
* 해쉬태그로 모든 학교의 관심있는 포스팅을 검색할 수 있습니다.
* 노티피케이션을 통해 내가 포스팅한 게시물에 다른 사람이 어떻게 반응하는지 확인 할 수 있습니다.
...
* **Backend**
  * Django Framework와 Django Rest Framework을 사용해 REST API 디자인 및 개발
  * Geofencing을 위해 Postgis와 GeoDjango를 사용해 GIS 웹 어플리케이션과 PostgreSQL의 SpatialDB 구축
  * 이메일 및 푸쉬 노티피케이션 발송을 위해 비동기 큐인 Celery와 브로커인 RabbitMQ를 사용하고 flower를 이용해 모니터링 구축
  * 각종 약관 페이지를 위해 Bootstrap3.0과 markdown 사용
...
* **Back-End & Infrastructure** 
  * 이미지 프로세싱(Deep Learning의 CNN)을 위한 REST API 서버를 개발하고 AWS의 인프라 위에 서비스를 구축
  * AWS의 GPU전용 Instance를 사용하고 CUDA 설정
  * 그 외 백앤드 구축을 위해 사용 된 대부분의 기술은 이전에 경험했던 기술(Django Framework, AWS등)을 재사용
  * DevOps툴로 Ansible 사용
...
* 동영상, 이미지, 텍스트의 전송을 통한 1:1 커뮤니케이션을 지원
</p></details>
